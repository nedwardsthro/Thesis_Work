...
replication. In the figure, black icon mean that trait of the analysis
is the same as the original while blue traits are different from the
original analysis.
...
|              | glass.       |              |              |
+--------------+--------------+--------------+--------------+
| Ball         | A high usage | FGA (10      | \% of FGA    |
| Dominant     | player,      | FT-3P)       | from 3       |
| Scorer       | typically a  |              |              |
|              | guard or     | Point Per    |              |
|              | wing, who is | Minute       |              |
|              | proficient   |              |              |
...
believe that a reduction in clusters would be optimal.

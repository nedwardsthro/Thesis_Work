...
+-----------+-----------+-----------+-----------+
| Cluster   | De        | High      | Low Stats |
|           | scription | Stats     |           |
+===========+===========+===========+===========+
| Skilled   | A big who | Def Reb.  | 3P FGA    |
| Big       | does      | %         |           |
|           | plays     |           |           |
|           | both      | 2P FG %   |           |
|           | inside    |           |           |
...
|           | Goal %.   |           |           |
+-----------+-----------+-----------+-----------+
| Comp      | Secondary | Assist    | Off. Reb  |
| limentary | creator   | Rate      | %         |
| Guard     | to the    |           |           |
|           | High      | 3P FG%    | Height    |
|           | Usage     |           |           |
|           | Scorer.   |           |           |
...
|           | bounding. |           |           |
+-----------+-----------+-----------+-----------+
| Three     | A guard   | 3P FG%    | Off. Reb  |
| Point     | or wing   |           | %         |
| Shooter   | who takes | 3P FGA    |           |
|           | a lot of  |           | FT Rate   |
|           | 3's and   |           |           |
|           | is highly |           |           |
|           | efficient |           |           |
...
|           | players.  |           |           |
+-----------+-----------+-----------+-----------+
| Tr        | Interior  | Off. Reb  | 3p FG%    |
| aditional | post      | %         |           |
| Center    | center    |           | Assist    |
|           | who       | FT Rate   | Rate      |
|           | shoots    |           |           |
|           | almost    |           |           |
|           | ex        |           |           |
...
|           | rate.     |           |           |
+-----------+-----------+-----------+-----------+
| Versatile | Group of  | Assist    | Off. Reb  |
| Role      | players   | Rate      | %         |
| Player    | who act   |           |           |
|           | as        | Usage     | FGA (0-10 |
|           | c         | Rate      | FT)       |

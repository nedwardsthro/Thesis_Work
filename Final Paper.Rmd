...
distributions produced by Gaussian mixture modeling (this figure is from an article on towardsdatascience.com).
...
#models_1_4%>%
#  summarize(sum(First_Prediction.x == First_Prediction.y)/nrow(models_1_4))
```

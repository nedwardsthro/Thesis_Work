...
+------------------+---------------------------+----------+----------+
| Cluster          | Description               | High     | Low      |
|                  |                           | Stats    | Stats    |
+==================+===========================+==========+==========+
| Skilled Big      | A big who does plays both | Def Reb. | 3P FGA   |
|                  | inside and outside of the | %        |          |
|                  | paint. Has a higher usage |          |          |
|                  | and scores more than the  | 2P FG %  |          |
|                  | Traditional Center. Has a |          |          |
|                  | very high 2 point Field   |          |          |
|                  | Goal %.                   |          |          |
+------------------+---------------------------+----------+----------+
| Complimentary    | Secondary creator to the  | Assist   | Off. Reb |
| Guard            | High Usage Scorer. Has    | Rate     | %        |
|                  | the highest assist rate   |          |          |
|                  | among the clusters and a  | 3P FG%   | Height   |
|                  | strong 3 point shooting   |          |          |
|                  | percentage, though this   |          |          |
|                  | cluster doesn't take many |          |          |
|                  | 3s. Weak in height and    |          |          |
|                  | defensive rebounding.     |          |          |
+------------------+---------------------------+----------+----------+
| Three Point      | A guard or wing who takes | 3P FG%   | Off. Reb |
| Shooter          | a lot of 3's and is       |          | %        |
|                  | highly efficient from 3.  | 3P FGA   |          |
|                  | Has a very low FT rate    |          | FT Rate  |
|                  | and does not crash the    |          |          |
|                  | offensive glass.          |          |          |
+------------------+---------------------------+----------+----------+
| Ball Dominant    | A high usage player,      | FGA (10  | \% of    |
| Scorer           | typically a guard or      | FT-3P)   | FGA from |
|                  | wing, who is proficient   |          | 3        |
|                  | at scoring and creating   | Point    |          |
|                  | for others. Does not      | Per      |          |
|                  | crash the offensive glass | Minute   |          |
|                  | and shoots a smaller      |          |          |
|                  | proportion of their shots |          |          |
|                  | from 3 as compared to     |          |          |
|                  | other players.            |          |          |
+------------------+---------------------------+----------+----------+
| Traditional      | Interior post center who  | Off. Reb | 3p FG%   |
| Center           | shoots almost exclusively | %        |          |
|                  | inside ten feet. High     |          | Assist   |
|                  | offensive rebounding rate | FT Rate  | Rate     |
|                  | and FT rate. Does not     |          |          |
|                  | have a very high assist   |          |          |
|                  | rate.                     |          |          |
+------------------+---------------------------+----------+----------+
| Versatile Role   | Group of players who act  | Assist   | Off. Reb |
| Player           | as chameleons on the      | Rate     | %        |
|                  | court and can do whatever |          |          |
|                  | is needed by their team.  | Usage    | FGA      |
|                  | Often serve as connectors | Rate     | (0-10    |
|                  | on the team, though they  |          | FT)      |
|                  | have lower assist rates   |          |          |
